...
<div class="align-middle min-w-full overflow-x-auto bg-white border border-secondary-grey overflow-hidden sm:rounded-lg p-4 my-8">
    <table {{ $attributes->merge(['class' => 'min-w-full w-full whitespace-nowrap']) }}>
        <thead>
            {{-- {{ $head }} --}}
            <tr>
            ...
            <tr tabindex="0" class="focus:outline-none h-16 rounded">
                ...
                <td class="">
                    <div class="flex items-center pl-5">
                        <p class="text-base font-medium leading-none text-gray-700 mr-2">Mathematics Secondary Level</p>
                ...
                <td class="pl-5">
                    <button class="py-3 px-1 text-sm focus:outline-none leading-none text-red-700 bg-red-100 rounded">Due today at 18:00</button>
                </td>
                <td class="pl-4">
